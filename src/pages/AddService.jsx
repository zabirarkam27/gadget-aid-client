        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg max-w-lg w-full space-y-4 relative">
            ...
            <div className="grid grid-cols-1 gap-2">
              <input className="input input-bordered" value={service._id} readOnly />
              <input className="input input-bordered" value={service.name} readOnly />
              <input className="input input-bordered" value={service.image} readOnly />
              <input className="input input-bordered" value={service.providerEmail} readOnly />
              <input className="input input-bordered" value={service.providerName} readOnly />
              <input className="input input-bordered" value={user.email} readOnly />
              <input className="input input-bordered" value={user.displayName} readOnly />
              <input
              ...
              />
              <input className="input input-bordered" value={`$${service.price}`} readOnly />
              <button
